...
// action function receives `shop` and `accessToken` dynamically
export async function action({ request, context }) {
  try {
    ...
    // =======================
    // 2. Shopify GraphQL helper (dynamic auth)
    // =======================
    // shop and accessToken should come from your session/context after OAuth
